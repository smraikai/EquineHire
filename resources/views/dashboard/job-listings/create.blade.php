            ...
            <form action="{{ route('dashboard.job-listings.store') }}" method="POST" class="p-6 bg-white rounded-lg shadow-sm"
                    ...
                    <div class="flex space-x-4">
                        <div class="flex items-center">
                            <input type="radio" id="remote_position_yes" name="remote_position" value="1"
                                ...
                                {{ old('remote_position') == '1' ? 'checked' : '' }} required>
                        ...
                        <div class="flex items-center">
                            <input type="radio" id="remote_position_no" name="remote_position" value="0"
                                class="text-blue-600 border-gray-300 focus:ring-blue-500"
                                {{ old('remote_position') == '0' ? 'checked' : '' }} required>
                ...
                <div class="mb-6">
                    ...
                    <select name="experience_required" id="experience_required"
                        ...
                        <option value="0-1 Years" {{ old('experience_required') == '0-1 Years' ? 'selected' : '' }}>0-1
                            Years</option>
                        <option value="1-2 Years" {{ old('experience_required') == '1-2 Years' ? 'selected' : '' }}>1-2
                            Years</option>
                        <option value="2-5 Years" {{ old('experience_required') == '2-5 Years' ? 'selected' : '' }}>2-5
                            Years</option>
                        <option value="5+ Years" {{ old('experience_required') == '5+ Years' ? 'selected' : '' }}>5+ Years
                        </option>
                    </select>
                ...
                <div class="mb-6">
                    ...
                    <select name="salary_type" id="salary_type"
                        ...
                        <option value="annual" {{ old('salary_type') == 'annual' ? 'selected' : '' }}>Annual</option>
                    </select>
                    @error('salary_type')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <select name="hourly_rate_min" id="hourly_rate_min"
                                ...
                                @for ($i = 10; $i <= 100; $i += 5)
                                    <option value="{{ $i }}"
                                        {{ old('hourly_rate_min') == $i ? 'selected' : '' }}>{{ $i }}.00
                                    </option>
                                @endfor
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <select name="hourly_rate_max" id="hourly_rate_max"
                                ...
                                @for ($i = 15; $i <= 200; $i += 5)
                                    <option value="{{ $i }}"
                                        {{ old('hourly_rate_max') == $i ? 'selected' : '' }}>{{ $i }}.00
                                    </option>
                                @endfor
                            </select>
                        </div>
                        ...
                        <div
                            ...
                            <select name="salary_range_min" id="salary_range_min"
                                ...
                                @for ($i = 10000; $i <= 100000; $i += 10000)
                                    <option value="{{ $i }}"
                                        {{ old('salary_range_min') == $i ? 'selected' : '' }}>
                                        {{ number_format($i) }}
                                    </option>
                                @endfor
                            </select>
                        ...
                        <div
                            ...
                            <select name="salary_range_max" id="salary_range_max"
                                ...
                                @for ($i = 20000; $i <= 300000; $i += 10000)
                                    <option value="{{ $i }}"
                                        {{ old('salary_range_max') == $i ? 'selected' : '' }}>
                                        {{ number_format($i) }}
                                    </option>
                                @endfor
                            </select>
                    ...
                    <div class="flex space-x-4">
                        <div class="flex items-center">
                            <input type="radio" id="application_type_link" name="application_type" value="link"
                                class="text-blue-600 border-gray-300 focus:ring-blue-500"
                                {{ old('application_type') == 'link' ? 'checked' : '' }} required>
                        ...
                        <div class="flex items-center">
                            <input type="radio" id="application_type_email" name="application_type" value="email"
                                class="text-blue-600 border-gray-300 focus:ring-blue-500"
                                {{ old('application_type') == 'email' ? 'checked' : '' }} required>
