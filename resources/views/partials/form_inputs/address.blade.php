<div class="relative mb-10">
    ...
    <div class="relative">
        ...
        <div id="address-icon-container" class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <x-coolicon-circle-check class="{{ $business->address ? '' : 'hidden' }} w-5 h-5 text-blue-500"
                id="address-icon-valid" />
            <x-coolicon-close-circle class="hidden w-5 h-5 text-red-500" id="address-icon-invalid" />
        </div>
    </div>
