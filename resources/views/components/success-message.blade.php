...
<div x-data="{ show: false }" x-init="$nextTick(() => {
    ...
    <div class="overflow-hidden rounded-lg shadow-lg bg-green-50 ring-1 ring-green-500 ring-opacity-50">
        <div class="p-4">
            <div class="flex items-start">
                ...
                <div class="flex flex-shrink-0 ml-4">
                    <button @click="show = false"
                        class="inline-flex text-green-600 rounded-md bg-green-50 hover:text-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
