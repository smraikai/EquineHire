    ...
    <section class="bg-white">
        <div class="max-w-5xl px-4 mx-auto lg:px-8">
            <div class="max-w-2xl mx-auto lg:mx-0">
                ...
                <p class="mt-2 text-lg leading-8 text-gray-600">Insights and advice for equestrian employers and job seekers.
                </p>
            </div>
            <hr class="my-10">
            @if ($latestPost)
                <a href="{{ route('blog.show', $latestPost->get('slug')) }}" class="block">
                    <article
                        class="flex flex-col-reverse overflow-hidden transition duration-300 ease-in-out rounded-md md:flex-row group">
                        ...
                        <div class="w-full overflow-hidden rounded-md md:w-1/2">
                            ...
                            <article
                                ...
                                <div class="relative w-full md:w-1/3 md:mr-6">
                                    <img src="{{ $post->get('featuredImage')->getFile()->getUrl() }}"
                                        alt="{{ $post->get('title') }}"
                                        class="object-cover w-full h-56 rounded-md aspect-[16/9]">
