...
@section('content')
    ...
    <section class="py-10 bg-white">
        <div class="px-4 py-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div
                class="grid grid-cols-2 gap-8 max-sm:flex max-sm:mx-auto max-sm:max-w-md max-sm:flex-wrap max-sm:justify-evenly max-sm:gap-x-8 max-sm:gap-y-8 md:grid-cols-6 lg:grid-cols-5 ">
                <div class="flex justify-center">
                    <img class="object-contain h-10 opacity-65 sm:h-16 md:h-20 lg:h-24 filter grayscale"
