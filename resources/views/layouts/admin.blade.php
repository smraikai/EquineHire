...
<head>
    ...
    <title>{{ $metaTitle ?? 'EquineHire Admin' }}</title>
...
<body class="h-full font-sans antialiased">
    <div class="min-h-full">
        ...
        <div class="lg:pl-72">
            <div
                class="sticky top-0 z-30 flex items-center h-16 px-4 bg-gray-900 text-white shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8">
                ...
                <!-- Separator -->
                <div class="w-px h-6 bg-gray-700 lg:hidden" aria-hidden="true"></div>
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                                ...
                                <div
                                    class="flex items-center justify-center w-8 h-8 text-sm font-semibold text-white bg-gray-700 rounded-full">
